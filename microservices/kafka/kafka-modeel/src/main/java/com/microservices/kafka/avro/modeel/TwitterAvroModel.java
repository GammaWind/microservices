 ...
 */
package com.microservices.kafka.avro.modeel;
...
public class TwitterAvroModel extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -7708854488690778369L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"TwitterAvroModel\",\"namespace\":\"com.microservices.kafka.avro.modeel\",\"fields\":[{\"name\":\"userId\",\"type\":\"long\"},{\"name\":\"id\",\"type\":\"long\"},{\"name\":\"text\",\"type\":[\"null\",\"string\"]},{\"name\":\"createdAt\",\"type\":[\"null\",\"long\"],\"logicalType\":[\"null\",\"date\"]}]}");
   ...
   */
  public static com.microservices.kafka.avro.modeel.TwitterAvroModel.Builder newBuilder() {
    return new com.microservices.kafka.avro.modeel.TwitterAvroModel.Builder();
  }
   ...
   * @return A new TwitterAvroModel RecordBuilder
   */
  public static com.microservices.kafka.avro.modeel.TwitterAvroModel.Builder newBuilder(com.microservices.kafka.avro.modeel.TwitterAvroModel.Builder other) {
    if (other == null) {
      return new com.microservices.kafka.avro.modeel.TwitterAvroModel.Builder();
    } else {
      return new com.microservices.kafka.avro.modeel.TwitterAvroModel.Builder(other);
    }
  }
   ...
   * @return A new TwitterAvroModel RecordBuilder
   */
  public static com.microservices.kafka.avro.modeel.TwitterAvroModel.Builder newBuilder(com.microservices.kafka.avro.modeel.TwitterAvroModel other) {
    if (other == null) {
      return new com.microservices.kafka.avro.modeel.TwitterAvroModel.Builder();
    } else {
      return new com.microservices.kafka.avro.modeel.TwitterAvroModel.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<TwitterAvroModel>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.microservices.kafka.avro.modeel.TwitterAvroModel.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.microservices.kafka.avro.modeel.TwitterAvroModel other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.userId)) {
        this.userId = data().deepCopy(fields()[0].schema(), other.userId);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.microservices.kafka.avro.modeel.TwitterAvroModel.Builder setUserId(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.microservices.kafka.avro.modeel.TwitterAvroModel.Builder clearUserId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.microservices.kafka.avro.modeel.TwitterAvroModel.Builder setId(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.microservices.kafka.avro.modeel.TwitterAvroModel.Builder clearId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.microservices.kafka.avro.modeel.TwitterAvroModel.Builder setText(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.microservices.kafka.avro.modeel.TwitterAvroModel.Builder clearText() {
      text = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.microservices.kafka.avro.modeel.TwitterAvroModel.Builder setCreatedAt(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.microservices.kafka.avro.modeel.TwitterAvroModel.Builder clearCreatedAt() {
      createdAt = null;
